    ...
    <Container>
      <div className="bg-about bg-center bg-cover bg-fixed bg-no-repeat">
        <Wrapper className="flex flex-col justify-center items-center min-h-[800px] backdrop-blur-xl min-w-full">
          <h2 className="drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] text-center pb-4 ">
            {t('who_are_we')}
          </h2>
          <div className="border border-1 pb-4 mb-12 md:w-[85%] gap-5 items-center justify-between">
